...
##Output tidy dataset
The tidy dataset that is generated by the script contains means of all 79 variables stratified by subject number and activity. A subset of the data is shown below as an example of the structure of the dataset:
